...
class BlackEdit {
    ...
    setEvents(self=this) {
        ...
        this.getFrame().addEventListener('click',function(e){
            ...
            // document.getElementById(`${self.editor_id}-img-form`).parentNode.classList.remove(`${self.editor_id}-hover-dropdown`);
    ...
    getOutput(auto=false) {
        if (auto) {
            this.getFrame().addEventListener('keypress', ()=>{
                _(`#${this.output_id}`)[0].innerText = this.getFrame().body.innerHTML;
            });
            this.getFrame().addEventListener('paste', ()=>{
                _(`#${this.output_id}`)[0].innerText = this.getFrame().body.innerHTML;
            });
            this.getFrame().addEventListener('cut', ()=>{
                _(`#${this.output_id}`)[0].innerText = this.getFrame().body.innerHTML;
            });
            this.getFrame().addEventListener('mouseup', ()=>{
                _(`#${this.output_id}`)[0].innerText = this.getFrame().body.innerHTML;
            });
        }
    ...
    init(auto_output=false, fill_output=false) {
        this.setStructure();
        ...
        setTimeout(()=>{
            ...
            fill_output ? this.getFrame().body.innerHTML = _(`#${this.output_id}`)[0].value: '';
        }, 100); 
    }
}